...
| **سرور VPN (TUN)** | **لینوکس / مک** | تماس‌ها را پاسخ می‌دهد، بسته‌های IP خام را روی دستگاه TUN هسته می‌گیرد (`bale0` در لینوکس، `utunN` در مک) و با NAT هسته (iptables در لینوکس، pf در مک) به اینترنت آزاد می‌فرستد. |
