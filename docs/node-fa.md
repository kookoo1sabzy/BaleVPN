...
وقتی یک کلاینت اندرویدی وصل می‌شود، آدرس `10.8.0.2/24` به او داده می‌شود و تمام ترافیکش وارد تونل می‌گردد.
...
- فقط یک دستگاه TUN، بنابراین در هر لحظه یک *کلاینت TUN فعال* داریم. سایر همتاها می‌توانند از طریق فریم‌بندی SOCKS5 روی همان کانال LK وصل شوند تا فقط TCP رله شود (جزییات در CLAUDE.md).
