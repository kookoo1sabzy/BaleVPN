try {
    ! function() {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            t = (new e.Error).stack;
        t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "700cf8d5-551a-46a2-92b9-3508316fc4e1", e._sentryDebugIdIdentifier = "sentry-dbid-700cf8d5-551a-46a2-92b9-3508316fc4e1")
    }()
} catch (e) {}! function() {
    try {
    ...
    var __webpack_modules__ = {
            65755: function(e, t, r) {
                e.exports = r.p + "static/js/rlottie-wasm.js"
            },
            33807: function(e, t, r) {
                let n, o;
                var i = r(25308);
                ...
                function s(e) {
                    n ? n.push(e) : (n = [e], Promise.resolve().then(() => {
                        let e = n;
                    ...
                    let r = [],
                        ...
                        o = l(() => {
                            let e = {
                                ...
                                o = n;
                            r = [], n = [], o.length ? postMessage(e, o) : postMessage(e)
                        });

                    function i(e, t) {
                        r.push(e), t && n.push(...t), o()
                    }
                    g(i), d.addCallback(r => {
                        var n;
                        (null == (n = r.data) ? void 0 : n.channel) === t && p(e, r.data, i)
                    })
                }
                ...
                function p(e, t, r, n) {
                    ...
                    }), t.payloads.forEach(t => u(this, void 0, void 0, function*() {
                        var o;
                        switch (t.type) {
                            case "init": {
                                let {
                                ...
                                "function" == typeof e ? yield e("init", n, ...r): yield null == (o = e.init) ? void 0 : o.call(e, n, ...r);
                                break
                            }
                            case "callMethod": {
                                let {
                                ...
                                try {
                                    if ("function" != typeof e && !e[o]) return;
                                    if (n && a) {
                                        let e = function() {
                                    ...
                                    let t = "function" == typeof e ? yield e(o, ...i): yield e[o](...i), {
                                        arrayBuffer: s
                ...
                function g(e) {
                    self.onerror = t => {
                        console.error(t), e({
                            type: "unhandledError",
                            error: {
                                message: t.error.message || "Uncaught exception in worker"
                            }
                        })
                        ...
                        console.error(t), e({
                            type: "unhandledError",
                            error: {
                                message: t.reason.message || "Uncaught rejection in worker"
                            }
                        })
                    })
                }
                onmessage = d.runCallbacks;
                let y = r.p + "static/js/rlottie-wasm.wasm";
                ...
                globalThis.Module = globalThis.Module || {}, globalThis.Module.locateFile = e => "rlottie-wasm.wasm" === e ? y : e, importScripts(new URL(r(65755), r.b));
                let E = new Promise(e => {
                        globalThis.Module.onRuntimeInitialized = () => {
                            let t = globalThis.Module;
                            o = {
                                init: t.cwrap("lottie_init", "", []),
                                destroy: t.cwrap("lottie_destroy", "", ["number"]),
                                resize: t.cwrap("lottie_resize", "", ["number", "number", "number"]),
                                buffer: t.cwrap("lottie_buffer", "number", ["number"]),
                                render: t.cwrap("lottie_render", "", ["number", "number"]),
                                loadFromData: t.cwrap("lottie_load_from_data", "number", ["number", "number"])
                            }, e()
                        }
                    }),
                    b = 60,
                ...
                function R(e) {
                    return _(this, void 0, void 0, function*() {
                        let t = yield fetch(e), r = t.headers.get("Content-Type"), n = e.toLowerCase().endsWith(".json"), o = (null == r ? void 0 : r.includes("json")) || "application/json" === r;
                        if (n || o) return t.text();
                        let a = yield t.arrayBuffer();
                        return (0, i.UD)(a, {
                            to: "string"
                        })
                    })
                ...
                function N(e, t, r) {
                    ...
                    return {
                        reduceFactor: s,
                        msPerFrame: 1e3 / (a / s),
                        reducedFramesCount: Math.ceil(r / s)
                    }
                }
                ...
                function M(e) {
                    ...
                    try {
                        let t = I.get(e);
                        t && (o.destroy(t.handle), I.delete(e))
                    } catch (r) {
                        t || setTimeout(() => M(e, !0), S)
                    }
                }
                h({
                    "rlottie:init": function(e, t, r, n, i) {
                        var a = arguments;
                        return _(this, void 0, void 0, function*() {
                            let s, l;
                            "function" == typeof i ? (s = void 0, l = i) : (s = i, l = a[5]), o || (yield E);
                            let c = yield R(t), u = allocate(intArrayFromString(c), "i8", 0), f = o.init(), d = o.loadFromData(f, u);
                            o.resize(f, r, r);
                            let h = new ImageData(r, r),
                                {
                                    reduceFactor: p,
                                    msPerFrame: m,
                                    reducedFramesCount: g
                                } = N(c, n, d);
                            I.set(e, {
                                imgSize: r,
                                reduceFactor: p,
                    ...
                    "rlottie:changeData": function(e, t, r, n) {
                        return _(this, void 0, void 0, function*() {
                            o || (yield E);
                            let i = yield R(t), a = allocate(intArrayFromString(i), "i8", 0), s = I.get(e);
                            if (!s) return;
                            let {
                                handle: l
                            } = s, {
                                reduceFactor: c,
                                msPerFrame: u,
                                reducedFramesCount: f
                            } = N(i, r, o.loadFromData(l, a));
                            n(c, u, f)
                        })
                    },
                    "rlottie:renderFrames": function(e, t, r) {
                        return _(this, void 0, void 0, function*() {
                            o || (yield E);
                            let n = I.get(e);
                            if (!n) return;
                            ...
                            o.render(s, u);
                            let f = o.buffer(s),
                                d = Module.HEAPU8.subarray(f, f + i * i * 4);
                            if (c) {
                                let e = new Uint8ClampedArray(d);
                                w(e, c), l.data.set(e)
                            } else l.data.set(d);
                            r(t, (yield createImageBitmap(l)))
                        })
                    },
                    "rlottie:destroy": M
                }, "rlottie")
            ...
            61571: function(e, t, r) {
                ...
                y = o = d([(0, u._G)(), p(0, (0, u.WQ)(c.W)), p(2, (0, u.WQ)("LogStore")), h("design:paramtypes", [Object, String, Object, Object, Function])], y);
                class _ {
                    constructor(e, t) {
                        var r = this;
                ...
                function b() {
                    f.k.bind("LoggerFactory").toFactory(E)
                }
                let v = () => f.k.get("LoggerFactory")
            },
 ...
 ${n}`), o.join("\n")
                    ...
                    y = {
                        [f]: "Failed to generate type declaration. Execute the below cmd to reproduce and fix the error."
                    },
                    _ = {
                        [d]: "Failed to find expose module.",
                        [h]: "PublicPath is required in prod mode."
                    },
                    E = {
                        ...g,
                        ...y,
                ...
                t.BUILD_001 = d, t.BUILD_002 = h, t.RUNTIME_001 = r, t.RUNTIME_002 = n, t.RUNTIME_003 = o, t.RUNTIME_004 = i, t.RUNTIME_005 = a, t.RUNTIME_006 = s, t.RUNTIME_007 = l, t.RUNTIME_008 = c, t.RUNTIME_009 = u, t.TYPE_001 = f, t.buildDescMap = _, t.errorDescMap = E, t.getShortErrorMsg = m, t.runtimeDescMap = g, t.typeDescMap = y
            },
            47926: function(e, t, r) {
                ...
                w(S, "__GLOBAL_LOADING_REMOTE_ENTRY__") || N(S, "__GLOBAL_LOADING_REMOTE_ENTRY__", {});
                let M = S.__GLOBAL_LOADING_REMOTE_ENTRY__;

                function $(e) {
                    w(e, "__VMOK__") && !w(e, "__FEDERATION__") && N(e, "__FEDERATION__", e.__VMOK__), w(e, "__FEDERATION__") || (N(e, "__FEDERATION__", {
                        __GLOBAL_PLUGIN__: [],
                        __INSTANCES__: [],
                        moduleInfo: {},
                        __SHARE__: {},
                ...
                function T() {
                    S.__FEDERATION__.__GLOBAL_PLUGIN__ = [], S.__FEDERATION__.__INSTANCES__ = [], S.__FEDERATION__.moduleInfo = {}, S.__FEDERATION__.__SHARE__ = {}, S.__FEDERATION__.__MANIFEST_LOADING__ = {}, Object.keys(M).forEach(e => {
                        delete M[e]
                    })
                }
                ...
                let P = () => I.__FEDERATION__.moduleInfo,
                    L = (e, t) => {
                        ...
                        if ("version" in e && e.version) {
                            let {
                                version: t,
                                ...r
                            } = e, n = f(r), o = D(I.__FEDERATION__.moduleInfo, n).value;
                            if ((null == o ? void 0 : o.version) === t) return o
                        }
                    },
                    F = e => L(e, I.__FEDERATION__.moduleInfo),
                    j = (e, t) => {
                        let r = f(e);
                        return I.__FEDERATION__.moduleInfo[r] = t, I.__FEDERATION__.moduleInfo
                    },
                    C = e => (I.__FEDERATION__.moduleInfo = {
                    ...
                    U = () => I.__FEDERATION__.__GLOBAL_PLUGIN__,
                    G = e => S.__FEDERATION__.__PRELOADED_MAP__.get(e),
                    V = e => S.__FEDERATION__.__PRELOADED_MAP__.set(e, !0),
                    W = "default",
                    B = "global",
                    q = "[0-9A-Za-z-]+",
                    z = `(?:\\+(${q}(?:\\.${q})*))`,
                    K = "0|[1-9]\\d*",
                    Y = "[0-9]+",
                    J = "\\d*[a-zA-Z-][a-zA-Z0-9-]*",
                    X = `(?:${Y}|${J})`,
                    Z = `(?:-?(${X}(?:\\.${X})*))`,
                    Q = `(?:${K}|${J})`,
                    ee = `(?:-(${Q}(?:\\.${Q})*))`,
                    et = `${K}|x|X|\\*`,
                    er = `[v=\\s]*(${et})(?:\\.(${et})(?:\\.(${et})(?:${ee})?${z}?)?)?`,
                    en = `^\\s*(${er})\\s+-\\s+(${er})\\s*$`,
                    eo = `(${Y})\\.(${Y})\\.(${Y})`,
                    ei = `[v=\\s]*${eo}${Z}?${z}?`,
                    ea = "((?:<|>)?=?)",
                ...
                function eN(e) {
                    return e.replace(eb(en), (e, t, r, n, o, i, a, s, l, c, u, f) => (t = ev(r) ? "" : ev(n) ? `>=${r}.0.0` : ev(o) ? `>=${r}.${n}.0` : `>=${t}`, s = ev(l) ? "" : ev(c) ? `<${Number(l)+1}.0.0-0` : ev(u) ? `<${l}.${Number(c)+1}.0-0` : f ? `<=${l}.${c}.${u}-${f}` : `<=${s}`, `${t} ${s}`.trim()))
                }

                function ew(e) {
                    return e.replace(eb(es), "$1$2$3")
                }

                function eM(e) {
                    return e.replace(eb(ec), "$1~")
                }

                function e$(e) {
                    return e.replace(eb(ef), "$1^")
                }

                function eT(e) {
                    return e.trim().split(/\s+/).map(e => e.replace(eb(eh), (e, t, r, n, o) => {
                        if (ev(t)) return "";
                        if (ev(r)) return `>=${t}.0.0 <${Number(t)+1}.0.0-0`;
                        if (ev(n))
                ...
                function eO(e) {
                    return e.trim().split(/\s+/).map(e => e.replace(eb(eg), (e, t, r, n, o) => ev(t) ? "" : ev(r) ? `>=${t}.0.0 <${Number(t)+1}.0.0-0` : ev(n) ? `>=${t}.${r}.0 <${t}.${Number(r)+1}.0-0` : o ? `>=${t}.${r}.${n}-${o} <${t}.${Number(r)+1}.0-0` : `>=${t}.${r}.${n} <${t}.${Number(r)+1}.0-0`)).join(" ")
                }

                function eA(e) {
                    return e.split(/\s+/).map(e => e.trim().replace(eb(ey), (e, t, r, n, o, i) => {
                        let a = ev(r),
                            s = a || ev(n),
                            l = s || ev(o);
                        if ("=" === t && l && (t = ""), i = "", a)
                ...
                function ek(e) {
                    return e.trim().replace(eb(ed), "")
                }

                function eD(e) {
                    return e.trim().replace(eb(eE), "")
                }
                ...
                function eF(e, t) {
                    return eP(e.major, t.major) || eP(e.minor, t.minor) || eP(e.patch, t.patch) || eL(e, t)
                }
                ...
                function eC(e, t) {
                    switch (e.operator) {
                        ...
                        case ">":
                            return 0 > eF(e, t);
                        case ">=":
                            return ej(e, t) || 0 > eF(e, t);
                        case "<":
                            return eF(e, t) > 0;
                        case "<=":
                            return ej(e, t) || eF(e, t) > 0;
                        case void 0:
                            return !0;
                        default:
                            return !1
                ...
                function ex(e) {
                    return eS(eT, eO, eA, ek)(e)
                }

                function eH(e) {
                    return eS(eN, ew, eM, e$)(e.trim()).split(/\s+/).join(" ")
                }
                ...
                function eU(e, t) {
                    ...
                    for (let e of t.split("||")) {
                        ...
                        try {
                            let e = eH(t);
                            if (!e.trim()) return !0;
                            let r = e.split(" ").map(e => ex(e)).join(" ");
                            if (!r.trim()) return !0;
                            let n = r.split(/\s+/).map(e => eD(e)).filter(Boolean);
                    ...
                    let r = t.shared || {},
                        ...
                        o = Object.keys(r).reduce((e, o) => {
                            ...
                            return e[o] = e[o] || [], i.forEach(r => {
                                e[o].push(eG(r, n, o, t.shareStrategy))
                            }), e
                        }, {}),
                        i = {
                            ...e.shared
                    ...
                    for (let s of Array.isArray(i) ? i : [i])
                        if (o && e[s] && e[s][t]) {
                            let {
                                ...
                                if (!1 === i || "*" === i || eU(u, i)) return e[s][t][u];
                                ...
                                pkgName: t,
                                version: u,
                                GlobalFederation: R.__FEDERATION__,
                                resolver: f
                            };
                ...
                function eZ() {
                    return R.__FEDERATION__.__SHARE__
                }
                ...
                let e2 = ".then(callbacks[0]).catch(callbacks[1])";
                async function e8(e) {
                    let {
                        entry: t,
                    ...
                    return new Promise((e, n) => {
                        try {
                            r ? e(r) : "undefined" != typeof FEDERATION_ALLOW_NEW_FUNCTION ? Function("callbacks", `import("${t}")${e2}`)([e, n]) : import(t).then(e).catch(n)
                        } catch (e) {
                            n(e)
                        }
                    })
                ...
                async function e3(e) {
                    ...
                    return new Promise((e, n) => {
                        try {
                            r ? e(r) : Function("callbacks", `System.import("${t}")${e2}`)([e, n])
                        } catch (e) {
                            n(e)
                        }
                    })
                ...
                var tl = {
                    ...
                    share: {
                        getRegisteredShare: eX,
                        getGlobalShareScope: eZ
                    },
                    utils: {
 ...
 ${n.safeToString(this.remoteInfo)}`), this.remoteEntryExports = e), this.remoteEntryExports
                    ...
                    async get(e, t, r, n) {
                        ...
                        })) || (i = await c.get(t)), s(i, `${f(this.remoteInfo)} remote don't export ${t}.`);
                        let u = v(this.remoteInfo.name, t),
                ...
                let tb = (e, t) => document.querySelector(`${e}[${"link"===e?"href":"src"}="${t}"]`);

                function tv(e, t, r, o, i) {
                    let a = [],
                        s = [],
                        l = [],
                        c = new Set,
                    ...
                    if (tE(o, r, (t, r, o) => {
                            ...
                            if (o) i = d;
                                ...
                                let e = h.find(e => e.nameOrAlias === r.name || e.nameOrAlias === r.alias);
                                if (!e) return;
                                i = to(e)
                            } else {
                                if (!0 !== h) return;
                            ...
                            let c = n.getResourceUrl(t, b(t).url);
                            c && l.push({
                                name: r.name,
                                moduleInfo: {
                                    name: r.name,
                            ...
                            let u = "modules" in t ? t.modules : [],
                                f = ta(i.exposes);
                            if (f.length && "modules" in t) {
                                var p;
                                u = null == t || null == (p = t.modules) ? void 0 : p.reduce((e, t) => ((null == f ? void 0 : f.indexOf(t.moduleName)) !== -1 && e.push(t), e), [])
                            }
                            ...
                            if (u) {
                                ...
                                for (let o = 0; o < n; o++) {
                                    ...
                                    e.remoteHandler.hooks.lifecycle.handlePreloadModule.emit({
                                        ...
                                        remote: r,
                                        origin: e
                                    }), G(l) || ("all" === i.resourceCategory ? (a.push(...m(n.assets.css.async)), a.push(...m(n.assets.css.sync)), s.push(...m(n.assets.js.async))) : (i.resourceCategory = "sync", a.push(...m(n.assets.css.sync))), s.push(...m(n.assets.js.sync)), V(l))
                                }
                            }
                        }, !0, {}, i), i.shared && i.shared.length > 0) {
                        let t = (t, r) => {
                            let n = eX(e.shareScopeMap, r.sharedName, t, e.sharedHandler.hooks.lifecycle.resolveShare);
                        ...
                        i.shared.forEach(e => {
                            var r;
                            let n = null == (r = f.shared) ? void 0 : r[e.sharedName];
                            if (!n) return;
                    ...
                    let p = s.filter(e => !c.has(e) && !tb("script", e));
                    return {
                        cssAssets: a.filter(e => !u.has(e) && !tb("link", e)),
                        jsAssetsWithoutEntry: p,
                        entryAssets: l.filter(e => !tb("script", e.url))
                    }
                }
                let tS = function() {
                    return {
                ...
                function tI(e, t) {
                    let r = F({
                        ...
                        n = r && "remotesInfo" in r && r.remotesInfo && D(r.remotesInfo, e.name).value;
                ...
                class tR {
                    async loadRemoteSnapshotInfo(e) {
                        ...
                        })), u && "remotesInfo" in u && !D(u.remotesInfo, i.name).value && ("version" in i || "entry" in i) && (u.remotesInfo = {
                    ...
                    constructor(e) {
                        this.loadingHostSnapshot = null, this.manifestCache = new Map, this.hooks = new tm({
                            beforeLoadRemoteSnapshot: new tf("beforeLoadRemoteSnapshot"),
                        ...
                        }), this.manifestLoading = R.__FEDERATION__.__MANIFEST_LOADING__, this.HostInstance = e, this.loaderHook = e.loaderHook
                    }
                }
                class tN {
                    registerShared(e, t) {
                    ...
                    async loadShare(e, t) {
                        ...
                        let i = eX(this.shareScopeMap, e, o, this.hooks.lifecycle.resolveShare),
                            a = e => {
                        ...
                        if (i) {
                            ...
                            let n = (async () => {
                                ...
                                let r = eX(this.shareScopeMap, e, o, this.hooks.lifecycle.resolveShare);
                    ...
                    loadShareSync(e, t) {
                        ...
                        let i = eX(this.shareScopeMap, e, n, this.hooks.lifecycle.resolveShare),
                            a = e => {
                                e.useIn || (e.useIn = []), u(e.useIn, r.options.name)
                            };
                        if (i) {
                    ...
                    constructor(e) {
                        this.hooks = new tm({
                            ...
                            loadShare: new tf,
                            resolveShare: new th("resolveShare"),
                            initContainerShareScopeMap: new th("initContainerShareScopeMap")
                ...
                class tw {
                    ...
                    async loadRemote(e, t) {
                        ...
                        try {
                            let {
                                ...
                                id: u,
                                remoteSnapshot: f
                            } = a, d = await o.get(u, c, t, f), h = await this.hooks.lifecycle.onLoad.emit({
                                id: u,
                                pkgNameOrAlias: s,
                                expose: c,
                            ...
                            if (this.setIdToRemoteMap(e, a), "function" == typeof h) return h;
                            return d
                        } catch (i) {
                            let {
                                from: n = "runtime"
                    ...
                    async getRemoteModuleAndOptions(e) {
                        ...
                        s(f && d, `The 'beforeRequest' hook was executed, but it failed to return the correct 'remote' and 'expose' values while loading ${i}.`);
                        let h = r.moduleCache.get(f.name),
                            p = {
                                host: r,
                                remoteInfo: c
                            };
                        return h || (h = new tc(p), r.moduleCache.set(f.name, h)), {
                            module: h,
                            moduleOptions: p,
                            remoteMatchInfo: u
                        }
                    ...
                    registerRemote(e, t, r) {
                        let {
                            ...
                            "entry" in e && n.isBrowserEnv() && !e.entry.startsWith("http") && (e.entry = new URL(e.entry, window.location.origin).href), e.shareScope || (e.shareScope = W), e.type || (e.type = B)
                        };
                    ...
                    removeRemote(e) {
                        try {
                            ...
                            if (a) {
                                ...
                                M[s] && delete M[s], r.snapshotHandler.manifestCache.delete(o.entry);
                                ...
                                if (u) {
                                    let t = u && "remotesInfo" in u && u.remotesInfo && D(u.remotesInfo, e.name).key;
                                    t && (delete u.remotesInfo[t], R.__FEDERATION__.__MANIFEST_LOADING__[t] && delete R.__FEDERATION__.__MANIFEST_LOADING__[t])
                                }
                    ...
                    constructor(e) {
                        this.hooks = new tm({
                            beforeRegisterRemote: new th("beforeRegisterRemote"),
                            registerRemote: new th("registerRemote"),
                            beforeRequest: new tp("beforeRequest"),
                            onLoad: new tf("onLoad"),
                            handlePreloadModule: new tu("handlePreloadModule"),
                            errorLoadRemote: new tf("errorLoadRemote"),
                            beforePreloadRemote: new tf("beforePreloadRemote"),
                            generatePreloadAssets: new tf("generatePreloadAssets"),
                            afterPreloadRemote: new tf,
                            loadEntry: new tf
                        }), this.host = e, this.idToRemoteMap = {}
                    }
                }
                let tM = "boolean" != typeof FEDERATION_OPTIMIZE_NO_SNAPSHOT_PLUGIN || !FEDERATION_OPTIMIZE_NO_SNAPSHOT_PLUGIN;
                class t$ {
                    initOptions(e) {
                    ...
                    constructor(e) {
                        this.hooks = new tm({
                            ...
                            createLink: new tu,
                            fetch: new tf,
                            loadEntryError: new tf,
                            getModuleFactory: new tf
                        ...
                        this.name = e.name, this.options = r, this.snapshotHandler = new tR(this), this.sharedHandler = new tN(this), this.remoteHandler = new tw(this), this.shareScopeMap = this.sharedHandler.shareScopeMap, this.registerPlugins([...r.plugins, ...e.plugins || []]), this.options = this.formatOptions(r, e)
                    }
                }
                var tT = Object.freeze({
                    __proto__: null
                });
                t.loadScript = n.loadScript, t.loadScriptNode = n.loadScriptNode, t.CurrentGlobal = S, t.Global = R, t.Module = tc, t.ModuleFederation = t$, t.addGlobalSnapshot = C, t.assert = s, t.getGlobalFederationConstructor = A, t.getGlobalSnapshot = P, t.getInfoWithoutType = D, t.getRegisteredShare = eX, t.getRemoteEntry = tr, t.getRemoteInfo = tn, t.helpers = tl, t.isStaticResourcesEqual = _, t.matchRemoteWithNameAndExpose = e1, t.registerGlobalPlugins = H, t.resetFederationGlobalInfo = T, t.safeWrapper = p, t.satisfy = eU, t.setGlobalFederationConstructor = k, t.setGlobalFederationInstance = O, t.types = tT
            },
            ...
            84582: function(__unused_webpack_module, exports) {
                ...
                function generateSnapshotFromManifest(e) {
                    ...
                    let {
                        ...
                        buildVersion: g,
                        globalName: y,
                        remoteEntry: simpleJoinRemoteEntry(d, h),
                        remoteEntryType: p,
                        ...
                        for (let [e, t] of Object.entries(o.scopeToSharingDataMapping))
                            for (let n of t)
                                if ("object" == typeof n && null !== n) {
                                    ...
                                    f(s) && (u.singleton = s), f(l) && (u.requiredVersion = l), f(a) && (u.eager = a), f(c) && (u.strictVersion = c);
                                    let d = {
                                        version: o,
                                        scope: [e],
                                        shareConfig: u,
...
while loading "${a[1]}" from ${a[2]}`), n.m[e] = () => {
                            ...
                            d = (e, t, r) => e ? f(n.I, a[0], 0, e, h, r) : l();
                        var h = (e, r, n) => f(r.get, a[1], t, 0, p, n),
                            p = t => {
                                a.p = 1, n.m[e] = e => {
                                    e.exports = t()
                                }
                        ...
                        1 === s.length && o.FEDERATION_SUPPORTED_TYPES.includes(s[0].externalType) && s[0].name ? f(m, a[2], 0, 0, p, 1) : f(n, a[2], 0, 0, d, 1)
                    })
                }
                ...
                function u(e) {
                    ...
                    a(o), o.o(i, t) && i[t].forEach(e => {
                        ...
                        try {
                            ...
                            f.then ? r.push(n[e] = f.then(t).catch(i)) : t(f)
                        } catch (e) {
                            i(e)
                        }
                    })
                ...
                function f(e) {
                    ...
                    var c = [],
                        u = function(e) {
                            ...
                            let u = n[e];
                            if (u) return u;
                            var f = e => "undefined" != typeof console && console.warn && console.warn(e),
                                d = n => {
                                    var o = e => f("Initialization of sharing external failed: " + e);
                                    try {
                                        var i = r(n);
                                        if (!i) return;
                                        ...
                                        if (i.then) return h.push(i.then(a, o));
                                        var l = a(i);
                                        if (l && "boolean" != typeof l && l.then) return h.push(l.catch(o))
                                    } catch (e) {
                                        o(e)
                                    }
                                };
                            let h = l.initializeSharing(e, {
                            ...
                            }), h.length) ? n[e] = Promise.all(h).then(() => n[e] = !0) : n[e] = !0
                        };
                    return l.forEach(e => {
                        c.push(u(e))
            ...
            16983: function(e, t, r) {
                var n, o, i, a, s, l, c, u, f, d, h, p, m = r(88976),
                    g = r.n(m);
                let y = [],
                    _ = {},
                    E = "web",
                ...
                if ((r.initializeSharingData || r.initializeExposesData) && r.federation) {
                    let e = (e, t, r) => {
                        ...
                        v = null != (u = null == (n = r.remotesLoadingData) ? void 0 : n.chunkMapping) ? u : {},
                        S = null != (f = null == (o = r.remotesLoadingData) ? void 0 : o.moduleIdToRemoteDataMapping) ? f : {},
                        I = null != (d = null == (i = r.initializeSharingData) ? void 0 : i.scopeToSharingDataMapping) ? d : {},
                        R = null != (h = null == (a = r.consumesLoadingData) ? void 0 : a.chunkMapping) ? h : {},
                        N = null != (p = null == (s = r.consumesLoadingData) ? void 0 : s.moduleIdToConsumeDataMapping) ? p : {},
                        w = {},
                        M = [],
                        $ = {},
                        T = null == (l = r.initializeExposesData) ? void 0 : l.shareScope;
                    ...
                    m(r.federation, "consumesLoadingModuleToHandlerMapping", () => {
                        ...
                        return e
                    }), m(r.federation, "initOptions", () => ({})), m(r.federation.initOptions, "name", () => E), m(r.federation.initOptions, "shareStrategy", () => b), m(r.federation.initOptions, "shared", () => {
                        let e = {};
    ...
    __webpack_require__.m = __webpack_modules__, __webpack_require__.c = __webpack_module_cache__, __webpack_require__.x = () => {
        var e = __webpack_require__.O(void 0, ["6591", "6525", "2989", "9015"], () => __webpack_require__(33807));
        ...
        __webpack_require__.u = e => "6591" === e ? "static/js/6591.a44597be.js" : "static/js/async/" + e + ".42baa99f.js"
    })(), (() => {
        ...
        __webpack_require__.x = () => Promise.all(["6591", "6525", "2989", "9015"].map(__webpack_require__.e, __webpack_require__)).then(e)
    })(), (() => {
...
//# sourceMappingURL=3942.2704e674.js.map