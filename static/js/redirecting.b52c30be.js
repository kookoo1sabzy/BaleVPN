try {
    ! function() {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {},
            t = (new e.Error).stack;
        t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "cd414d3e-4302-47ef-b226-253fe1ff67f1", e._sentryDebugIdIdentifier = "sentry-dbid-cd414d3e-4302-47ef-b226-253fe1ff67f1")
    }()
} catch (e) {}! function() {
    try {
 ...
 ${n}`), o.join("\n")
            ...
            47926: function(e, t, r) {
                ...
                let $ = S.__GLOBAL_LOADING_REMOTE_ENTRY__;
                ...
                function T() {
                    S.__FEDERATION__.__GLOBAL_PLUGIN__ = [], S.__FEDERATION__.__INSTANCES__ = [], S.__FEDERATION__.moduleInfo = {}, S.__FEDERATION__.__SHARE__ = {}, S.__FEDERATION__.__MANIFEST_LOADING__ = {}, Object.keys($).forEach(e => {
                        delete $[e]
                    })
                }
                ...
                function ex(e) {
                    return eS(eN, ew, e$, eM)(e.trim()).split(/\s+/).join(" ")
                }
 ...
 ${n.safeToString(this.remoteInfo)}`), this.remoteEntryExports = e), this.remoteEntryExports
                    ...
                    removeRemote(e) {
                        try {
                            ...
                            if (a) {
                                ...
                                $[s] && delete $[s], r.snapshotHandler.manifestCache.delete(o.entry);
                ...
                let t$ = "boolean" != typeof FEDERATION_OPTIMIZE_NO_SNAPSHOT_PLUGIN || !FEDERATION_OPTIMIZE_NO_SNAPSHOT_PLUGIN;
                class tM {
                    initOptions(e) {
...
while loading "${a[1]}" from ${a[2]}`), n.m[e] = () => {
            ...
            35174: function(e, t, r) {
                var n = r(53703);
                let o = "maviz_payment";

                function i() {
                    let e = new n.X2(o),
                        t = new URLSearchParams(window.location.search).get("BaleRK");
                    if (t) {
                        let r = setTimeout(window.close, 3e4),
                            n = e => {
                                let {
                                    key: n,
                                    url: o,
    ...
    __webpack_require__.m = __webpack_modules__, __webpack_require__.c = __webpack_module_cache__, __webpack_require__.x = () => {
        var e = __webpack_require__.O(void 0, ["6591", "2028", "2989", "1396"], () => __webpack_require__(35174));
...
//# sourceMappingURL=redirecting.b52c30be.js.map