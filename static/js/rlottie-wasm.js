var key, read_, readAsync, readBinary, setWindowTitle, nodeFS, nodePath, wasmBinary, noExitRuntime, wasmMemory, buffer, HEAP8, HEAPU8, HEAP16, HEAPU16, HEAP32, HEAPU32, HEAPF32, HEAPF64, tempDouble, tempI64, calledRun, Module = void 0 !== Module ? Module : {},
    moduleOverrides = {};
...
function dynamicAlloc(e) {
    ...
    return HEAP32[DYNAMICTOP_PTR >> 2] = r + e + 15 & -16, r
}
...
function setValue(e, r, t, n) {
    switch ("*" === (t = t || "i8").charAt(t.length - 1) && (t = "i32"), t) {
        ...
        case "i32":
            ...
            break;
        case "i64":
            tempI64 = [r >>> 0, +Math_abs(tempDouble = r) >= 1 ? tempDouble > 0 ? Math_min(+Math_floor(tempDouble / 0x100000000), 0xffffffff) >>> 0 : ~~Math_ceil((tempDouble - (~~tempDouble >>> 0)) / 0x100000000) >>> 0 : 0], HEAP32[e >> 2] = tempI64[0], HEAP32[e + 4 >> 2] = tempI64[1];
            break;
        case "float":
            HEAPF32[e >> 2] = r;
            break;
...
function ccall(e, r, t, n, o) {
    ...
    if (n)
        for (var c = 0; c < n.length; c++) {
            var d = i[t[c]];
            d ? (0 === l && (l = stackSave()), u[c] = d(n[c])) : u[c] = n[c]
        }
    var f = s.apply(null, u);
    return a = f, f = "string" === r ? UTF8ToString(a) : "boolean" === r ? !!a : a, 0 !== l && stackRestore(l), f
}
...
function allocate(e, r, t, n) {
    ...
    if (s = t == ALLOC_NONE ? n : [_malloc, stackAlloc, dynamicAlloc][t](Math.max(i, o ? 1 : r.length)), a) {
        for (n = s, assert((3 & s) == 0), u = s + (-4 & i); n < u; n += 4) HEAP32[n >> 2] = 0;
        for (u = s + i; n < u;) HEAP8[0 | n++] = 0;
        return s
    }
    if ("i8" === o) return e.subarray || e.slice ? HEAPU8.set(e, s) : HEAPU8.set(new Uint8Array(e), s), s;
    for (var a, i, s, u, l, c, d, f = 0; f < i;) {
        var m = e[f];
        if (0 === (l = o || r[f])) {
            f++;
            continue
        }
        "i64" == l && (l = "i32"), setValue(s + f, m, l), d !== l && (c = getNativeTypeSize(l), d = l), f += c
    }
    return s
}
...
function UTF8ArrayToString(e, r, t) {
    ...
    for (var a = ""; r < o;) {
        ...
        var u = 63 & e[r++];
        if ((i = (240 & i) == 224 ? (15 & i) << 12 | s << 6 | u : (7 & i) << 18 | s << 12 | u << 6 | 63 & e[r++]) < 65536) a += String.fromCharCode(i);
        else {
            var l = i - 65536;
...
var DYNAMIC_BASE = 5275232,
    ...
    INITIAL_INITIAL_MEMORY = Module.INITIAL_MEMORY || 0x1000000;
...
function callRuntimeCallbacks(e) {
    ...
    maximum: 0x80000000 / WASM_PAGE_SIZE
...
function initRuntime() {
    Module.noFSInit || FS.init.initialized || FS.init(), TTY.init(), callRuntimeCallbacks(__ATINIT__)
}
...
function abort(e) {
    throw Module.onAbort && Module.onAbort(e), out(e += ""), err(e), ABORT = !0, e = "abort(" + e + "). Build with -s ASSERTIONS=1 for more info.", new WebAssembly.RuntimeError(e)
}
...
function getBinaryPromise() {
    return !wasmBinary && (ENVIRONMENT_IS_WEB || ENVIRONMENT_IS_WORKER) && "function" == typeof fetch && !isFileURI(wasmBinaryFile) ? fetch(wasmBinaryFile, {
...
function createWasm() {
    ...
    function r(e, r) {
        Module.asm = e.exports, removeRunDependency("wasm-instantiate")
    }
...
var PATH = {
        ...
        stream_ops: {
            ...
            read: function(e, r, t, n, o) {
                ...
                for (var a, i = 0, s = 0; s < n; s++) {
                    ...
                    if (void 0 === a && 0 === i) throw new FS.ErrnoError(6);
                    if (null == a) break;
                    i++, r[t + s] = a
                }
                ...
                if (!e.input.length) {
                    ...
                    if (ENVIRONMENT_IS_NODE) {
                        ...
                        try {
                            ...
                            if (-1 != e.toString().indexOf("EOF")) n = 0;
                            else throw e
                        }
        ...
        stream_ops: {
            ...
            write: function(e, r, t, n, o, a) {
                ...
                if (i.timestamp = Date.now(), r.subarray && (!i.contents || i.contents.subarray)) {
                    ...
                    else if (0 === i.usedBytes && 0 === o) return i.contents = r.slice(t, t + n), i.usedBytes = n, n;
                    else if (o + n <= i.usedBytes) return i.contents.set(r.subarray(t, t + n), o), n
                }
    ...
    FS = {
        ...
        lookupPath: function(e, r) {
            if (e = PATH_FS.resolve(FS.cwd(), e), r = r || {}, !e) return {
                path: "",
                node: null
            };
            var t = {
        ...
        nodePermissions: function(e, r) {
            return FS.ignorePermissions ? 0 : 2 * (-1 !== r.indexOf("r") && !(292 & e.mode) || -1 !== r.indexOf("w") && !(146 & e.mode) || -1 !== r.indexOf("x") && !(73 & e.mode))
        },
        mayLookup: function(e) {
            var r = FS.nodePermissions(e, "x");
            return r || 2 * !e.node_ops.lookup
        },
        ...
        mayDelete: function(e, r, t) {
            ...
            var n, o = FS.nodePermissions(e, "wx");
            if (o) return o;
            if (t) {
        ...
        create: function(e, r) {
            return r = (void 0 !== r ? r : 438) & 4095 | 32768, FS.mknod(e, r, 0)
        },
        mkdir: function(e, r) {
            return r = (void 0 !== r ? r : 511) & 1023 | 16384, FS.mknod(e, r, 0)
        },
        ...
        rename: function(e, r) {
            ...
            var l = FS.lookupNode(t, s),
                c = PATH_FS.relative(e, i);
            if ("." !== c.charAt(0)) throw new FS.ErrnoError(28);
            if ("." !== (c = PATH_FS.relative(r, a)).charAt(0)) throw new FS.ErrnoError(55);
            try {
                o = FS.lookupNode(n, u)
            } catch (e) {}
            if (l !== o) {
                var d = FS.isDir(l.mode),
                    f = FS.mayDelete(t, s, d);
                if (f || (f = o ? FS.mayDelete(n, u, d) : FS.mayCreate(n, u))) throw new FS.ErrnoError(f);
                if (!t.node_ops.rename) throw new FS.ErrnoError(63);
                if (FS.isMountpoint(l) || o && FS.isMountpoint(o)) throw new FS.ErrnoError(10);
        ...
        open: function(e, r, t, n, o) {
            ...
            if (r = "string" == typeof r ? FS.modeStringToFlags(r) : r, t = void 0 === t ? 438 : t, t = 64 & r ? 4095 & t | 32768 : 0, "object" == typeof e) a = e;
            else {
                e = PATH.normalize(e);
                try {
                    var a;
            ...
            try {
                if (FS.trackingDelegate.onOpenFile) {
                    var l = 0;
                    (2097155 & r) != 1 && (l |= FS.tracking.openFlags.READ), (2097155 & r) != 0 && (l |= FS.tracking.openFlags.WRITE), FS.trackingDelegate.onOpenFile(e, l)
                }
            } catch (r) {
        ...
        mmap: function(e, r, t, n, o, a, i) {
            if ((2 & a) != 0 && (2 & i) == 0 && (2097155 & e.flags) != 2 || (2097155 & e.flags) == 1) throw new FS.ErrnoError(2);
        ...
        readFile: function(e, r) {
            if ((r = r || {}).flags = r.flags || "r", r.encoding = r.encoding || "binary", "utf8" !== r.encoding && "binary" !== r.encoding) throw Error('Invalid encoding type "' + r.encoding + '"');
            ...
            return FS.registerDevice(i, {
                ...
                read: function(e, r, n, o, a) {
                    for (var i, s = 0, u = 0; u < o; u++) {
                        ...
                        if (void 0 === i && 0 === s) throw new FS.ErrnoError(6);
                        if (null == i) break;
                        s++, r[n + u] = i
                    }
        ...
        createLazyFile: function(e, r, t, n, o) {
            ...
            if (a.prototype.get = function(e) {
                    ...
                    if (r.open("HEAD", t, !1), r.send(null), !(r.status >= 200 && r.status < 300 || 304 === r.status)) throw Error("Couldn't load " + t + ". Status: " + r.status);
                    var n = Number(r.getResponseHeader("Content-length")),
                    ...
                    var s = function(e, r) {
                            ...
                            if (r > n - 1) throw Error("only " + n + " bytes available! programmer error!");
                            var o = new XMLHttpRequest;
                            if (o.open("GET", t, !1), n !== i && o.setRequestHeader("Range", "bytes=" + e + "-" + r), "undefined" != typeof Uint8Array && (o.responseType = "arraybuffer"), o.overrideMimeType && o.overrideMimeType("text/plain; charset=x-user-defined"), o.send(null), !(o.status >= 200 && o.status < 300 || 304 === o.status)) throw Error("Couldn't load " + t + ". Status: " + o.status);
                    ...
                    u.setDataGetter(function(e) {
                        var r = e * i,
                            t = (e + 1) * i - 1;
                        if (t = Math.min(t, n - 1), void 0 === u.chunks[e] && (u.chunks[e] = s(r, t)), void 0 === u.chunks[e]) throw Error("doXHR failed!");
                        return u.chunks[e]
                    }), (a || !n) && (i = n = 1, i = n = this.getter(0).length, out("LazyFiles on gzip forces download of the whole file when length is accessed")), this._length = n, this._chunkSize = i, this.lengthKnown = !0
            ...
            return Object.keys(u.stream_ops).forEach(function(e) {
                ...
                if (a.slice)
                    ...
                    for (var s = 0; s < i; s++) r[t + s] = a.get(o + s);
                return i
            }, u.stream_ops = l, u
        },
    ...
    SYSCALLS = {
        ...
        doStat: function(e, r, t) {
            ...
            return HEAP32[t >> 2] = n.dev, HEAP32[t + 4 >> 2] = 0, HEAP32[t + 8 >> 2] = n.ino, HEAP32[t + 12 >> 2] = n.mode, HEAP32[t + 16 >> 2] = n.nlink, HEAP32[t + 20 >> 2] = n.uid, HEAP32[t + 24 >> 2] = n.gid, HEAP32[t + 28 >> 2] = n.rdev, HEAP32[t + 32 >> 2] = 0, tempI64 = [n.size >>> 0, +Math_abs(tempDouble = n.size) >= 1 ? tempDouble > 0 ? Math_min(+Math_floor(tempDouble / 0x100000000), 0xffffffff) >>> 0 : ~~Math_ceil((tempDouble - (~~tempDouble >>> 0)) / 0x100000000) >>> 0 : 0], HEAP32[t + 40 >> 2] = tempI64[0], HEAP32[t + 44 >> 2] = tempI64[1], HEAP32[t + 48 >> 2] = 4096, HEAP32[t + 52 >> 2] = n.blocks, HEAP32[t + 56 >> 2] = n.atime.getTime() / 1e3 | 0, HEAP32[t + 60 >> 2] = 0, HEAP32[t + 64 >> 2] = n.mtime.getTime() / 1e3 | 0, HEAP32[t + 68 >> 2] = 0, HEAP32[t + 72 >> 2] = n.ctime.getTime() / 1e3 | 0, HEAP32[t + 76 >> 2] = 0, tempI64 = [n.ino >>> 0, +Math_abs(tempDouble = n.ino) >= 1 ? tempDouble > 0 ? Math_min(+Math_floor(tempDouble / 0x100000000), 0xffffffff) >>> 0 : ~~Math_ceil((tempDouble - (~~tempDouble >>> 0)) / 0x100000000) >>> 0 : 0], HEAP32[t + 80 >> 2] = tempI64[0], HEAP32[t + 84 >> 2] = tempI64[1], 0
        },
    ...
    try {
        ...
        switch (r) {
            case 0:
                var o = SYSCALLS.get();
                if (o < 0) return -28;
                return FS.open(n.path, n.flags, 0, o).fd;
            case 1:
            case 2:
            case 13:
            case 14:
...
function _saveSetjmp(e, r, t, n) {
    e |= 0, r |= 0, t |= 0, n |= 0;
    var o = 0;
    for (setjmpId = setjmpId + 1 | 0, HEAP32[e >> 2] = setjmpId;
        (0 | o) < (0 | n);) {
        if ((0 | HEAP32[t + (o << 3) >> 2]) == 0) return HEAP32[t + (o << 3) >> 2] = setjmpId, HEAP32[t + ((o << 3) + 4) >> 2] = r, HEAP32[t + ((o << 3) + 8) >> 2] = 0, setTempRet0(0 | n), 0 | t;
        o = o + 1 | 0
    }
    return t = 0 | _saveSetjmp(0 | e, 0 | r, 0 | (t = 0 | _realloc(0 | t, 8 * ((n = 2 * n | 0) + 1 | 0) | 0)), 0 | n), setTempRet0(0 | n), 0 | t
}

function _testSetjmp(e, r, t) {
    e |= 0, r |= 0, t |= 0;
    for (var n = 0, o = 0;
        (0 | n) < (0 | t) && (0 | (o = 0 | HEAP32[r + (n << 3) >> 2])) != 0;) {
        if ((0 | o) == (0 | e)) return 0 | HEAP32[r + ((n << 3) + 4) >> 2];
        n = n + 1 | 0
    }
    return 0
}
...
function _emscripten_resize_heap(e) {
    ...
    for (var t = 1; t <= 4; t *= 2) {
        var n = r * (1 + .2 / t);
        if (n = Math.min(n, e + 0x6000000), emscripten_realloc_buffer(Math.min(0x80000000, alignUp(Math.max(0x1000000, e, n), 65536)))) return !0
    }
    return !1
}
var ENV = {};
...
function _fd_seek(e, r, t, n, o) {
    try {
        var a = SYSCALLS.getStreamFromFD(e),
            i = 0x100000000 * t + (r >>> 0);
        if (i <= -0x20000000000000 || i >= 0x20000000000000) return -61;
        return FS.llseek(a, i, n), tempI64 = [a.position >>> 0, (tempDouble = a.position, +Math_abs(tempDouble) >= 1 ? tempDouble > 0 ? Math_min(+Math_floor(tempDouble / 0x100000000), 0xffffffff) >>> 0 : ~~Math_ceil((tempDouble - (~~tempDouble >>> 0)) / 0x100000000) >>> 0 : 0)], HEAP32[o >> 2] = tempI64[0], HEAP32[o + 4 >> 2] = tempI64[1], a.getdents && 0 === i && 0 === n && (a.getdents = null), 0
    } catch (e) {
        return void 0 !== FS && e instanceof FS.ErrnoError || abort(e), e.errno
    }
}
...
function _round(e) {
    return (e *= 1) >= 0 ? +Math_floor(e + .5) : +Math_ceil(e - .5)
}
...
function __addDays(e, r) {
    for (var t = new Date(e.getTime()); r > 0;) {
        ...
        if (r > a - t.getDate()) r -= a - t.getDate() + 1, t.setDate(1), o < 11 ? t.setMonth(o + 1) : (t.setMonth(0), t.setFullYear(t.getFullYear() + 1));
        else {
...
function _strftime(e, r, t, n) {
    ...
    for (var u in s) i = i.replace(RegExp(u, "g"), s[u]);
    ...
    function m(e, r) {
        ...
        return 0 === (t = n(e.getFullYear() - r.getFullYear())) && 0 === (t = n(e.getMonth() - r.getMonth())) && (t = n(e.getDate() - r.getDate())), t
    }
    ...
    function p(e) {
        var r = __addDays(new Date(e.tm_year + 1900, 0, 1), e.tm_yday),
            ...
            o = S(t),
            a = S(n);
        return 0 >= m(o, r) ? 0 >= m(a, r) ? r.getFullYear() + 1 : r.getFullYear() : r.getFullYear() - 1
    }
    var _ = {
        "%a": function(e) {
        ...
        "%U": function(e) {
            ...
            if (0 > m(t, n)) {
                ...
                return f(Math.ceil((31 - t.getDate() + o + n.getDate()) / 7), 2)
            }
        ...
        "%V": function(e) {
            ...
            return 0 > m(a, n) ? "53" : 0 >= m(o, a) ? "01" : f(Math.ceil((n.getFullYear() < e.tm_year + 1900 ? e.tm_yday + 32 - n.getDate() : e.tm_yday + 1 - n.getDate()) / 7), 2)
        },
        "%w": function(e) {
            return e.tm_wday
        },
        ...
        "%z": function(e) {
            var r = e.tm_gmtoff;
            return (r >= 0 ? "+" : "-") + String("0000" + (r = (r = Math.abs(r) / 60) / 60 * 100 + r % 60)).slice(-4)
        },
        "%Z": function(e) {
            return e.tm_zone
        },
    ...
    for (var u in _) i.indexOf(u) >= 0 && (i = i.replace(RegExp(u, "g"), _[u](a)));
...
function intArrayFromString(e, r, t) {
    var n = Array(t > 0 ? t : lengthBytesUTF8(e) + 1),
        o = stringToUTF8Array(e, n, 0, n.length);
